...
>
> If the parameter isStartWithSavePoint is true, the jobId is required. If the parameter isStartWithSavePoint is false, the jobId is not required and will be generated by seatunnel
>
  #### Body
