...
@Getter
public class ChronicleWriterOptions implements Serializable {
    ...
    /** Builder For {@link ChronicleWriterOptions}. */
    public static class Builder {
        ...
        public ChronicleWriterOptions build() {
            return new ChronicleWriterOptions(
                    connectString,
                    database,
                    collection,
                    flushSize,
