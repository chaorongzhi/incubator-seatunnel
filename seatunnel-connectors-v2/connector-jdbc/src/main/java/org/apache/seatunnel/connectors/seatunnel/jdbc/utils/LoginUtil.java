...
public class LoginUtil {
    ...
    public static void setZookeeperServerPrincipal(
            String zkServerPrincipalKey, String zkServerPrincipal) throws IOException {
            ...
            if (!useTicketCache) {
                if (IS_IBM_JDK) {
                    ...
                    KEYTAB_KERBEROS_OPTIONS.put(
                            "useTicketCache", useTicketCache ? "true" : "false");
                }
            }
