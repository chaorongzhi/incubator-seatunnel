package org.apache.seatunnel.connectors.seatunnel.elasticsearch.hw.util;
...
public class LoginUtil {
     ...
     * @throws IOException
     */
    public static synchronized void setJaasFile(
            String principal, String keytabPath, String customJaasPath) throws IOException {
        String jaasPath;
        if (customJaasPath != null && customJaasPath.trim().length() != 0) {
